      ...
      <article>
        <div className="mb-8">
          ...
          <div className="border-t border-b border-gray-200 py-4 my-6">
            ...
            <span className="text-gray-700 mt-6 flex items-center">
              작성자: ychanwoo
            </span>
          </div>
        </div>
        ...
        <div className="mt-8">
          ...
          <Button
            href="/Posts/List"
            className="bg-yellow-300 hover:bg-yellow-400 text-gray-800 px-4 py-2 rounded-lg mx-5"
          >
            수정
          </Button>
          <Button
            href="/Posts/List"
            className="bg-red-300 hover:bg-red-400 text-gray-800 px-4 py-2 rounded-lg"
